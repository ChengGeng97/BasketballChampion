...
if (!other.first_time)
{
	...
	var new_vector_x = other.real_ball_speed * other.x_direction + gravity_vector_x;
	var new_vector_y = other.real_ball_speed * other.y_direction + gravity_vector_y;
	...
	other.real_ball_speed = new_ball_speed;
