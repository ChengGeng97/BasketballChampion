...
var continueButton = instance_create_depth(1284, 450, 0, RoomChangingButtonResetLives);
continueButton.text = "Retry this Level!";
continueButton.scale = 2;
continueButton.room_to_go = room;

var restartButton = instance_create_depth(1284, 550, 0, RoomChangingButtonResetLives);
